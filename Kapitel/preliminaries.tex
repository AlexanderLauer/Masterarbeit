...
\begin{definition}[\textbf{minimal uppergraph}]
Let $G_1$ and $G_2$ be graphs with $G_1 \subseteq G_2$. 
A graph $C$ is called an \emph{minimal uppergraph} of $G_1$ w.r.t $G_2$, if $G_1 \subset C \subseteq G_2$ and no graph $C' \subset C$ with $G_1 \subset C \subseteq G_2$ exists.
The set of minimal uppergraphs of $G_1$ w.r.t. $G_2$ is denoted by $\mathcal{U}(G_1,G_2)$. If $G_1 = G_2$, we set $\mathcal{U}(G_1,G_2) = \{G_1\}$.
