...
A graph $C$ is called an \emph{intermediate-graph} of $G_1$ and $G_2$, if injective morphisms $p_1: G_1 \inj C$ and $p': C \inj G_2$ exist. 
The set of intermediate-graphs of $G_1$ and $G_2$ is denoted by $\ig{G_1}{G_2}$.
