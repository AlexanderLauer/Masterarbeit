...
A transformation $t: G \Longrightarrow_{\rho,m} H$ is called \emph{direct minimal consistency improving} if $G \models_{k-1}c$ and equations (\ref{direct_improving_1}), (\ref{direct_improving_1_2}) and (\ref{direct_improving_2}) hold. 
