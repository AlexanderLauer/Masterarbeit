...
\begin{proof}
	...
	Therefore, either the no new violation by deletion, no new violation by insertion, no satisfied layer reduction by insertion or no satisfied layer reduction by deletion formula is not satisfied.
	\begin{enumerate}
		\item 
...
The main idea of the concept of derived rules is to extend a given set of rules by as many basic increasing rules as possible without extending its semantic.
