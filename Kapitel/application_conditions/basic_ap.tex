...
Since basic rules are consistency-maintaining at a certain layer $k$ it suffices to check whether $m \circ i \models \exists(C_{k+3}, \true)$ if $\rho$ is a deleting rule, and whether $m \circ i \models \exists(C', \true)$ if $\rho$ is an inserting rule, where $m$ is the match of the transformation and $i$ is the increasing morphism of $\rho$.
