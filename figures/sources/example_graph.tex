...
\begin{document}
	...
	%	SClass-phantom/.style={text width={width(": Feature")},align=center,draw},
		...
		%G
		\node(C32) [title] {$G$};
		\node(class32) [SClass, below right=15pt and 40pt of C32.west, anchor=west]{\scriptsize gc1:Class};
		...
		\node(class2) [SClass,  right=100pt  of class32.west, anchor=west]{\scriptsize gc2:Class};	
